...
city_nums = [8, 2, 4]  # mtrain, mvalid, mtest
...
poi_type_num = 229
record_num = 10
time_str = '2021-08-14 10:00:00'  # This is fake: all records use the same timestamp
user_loc = '(777,888)'
poi_loc = '(778,889)'
poi_name = 'fake'
    ...
    with open(file_name, 'w') as f:
        for u in range(user_num):
            ...
            for r in range(record_num):
                ...
                line += '\t' + '_'.join([time_str, poi_id, poi_loc, poi_name, poi_type, user_loc, 'x'])
            f.write(line + '\n')
